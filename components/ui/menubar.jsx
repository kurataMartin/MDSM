...
const MenubarSubTrigger = forwardRef(function MenubarSubTrigger({ className, inset, children, ...props }, ref) {
  return (
...
const MenubarContent = forwardRef(function MenubarContent({ className, align = 'start', alignOffset = -4, sideOffset = 8, ...props }, ref) {
  return (
...
const MenubarCheckboxItem = forwardRef(function MenubarCheckboxItem({ className, children, checked, ...props }, ref) {
  return (
...
const MenubarRadioItem = forwardRef(function MenubarRadioItem({ className, children, ...props }, ref) {
  return (
